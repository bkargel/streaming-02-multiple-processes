...
INPUT_FILE_NAME = "hurricanes.csv"
OUTPUT_FILE_NAME = "out9.txt"


def prepare_message_from_row(row):
    """Prepare a binary message from a given row."""
    RowID, Year, NamedStorms, Hurricanes, MajorHurricanes = row
    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{RowID}, {Year}, {NamedStorms}, {Hurricanes}, {MajorHurricanes}]"
